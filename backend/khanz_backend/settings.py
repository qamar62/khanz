"""
Django settings for khanz_backend project.
"""
...
ROOT_URLCONF = 'khanz_backend.urls'
...
WSGI_APPLICATION = 'khanz_backend.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@khanz.co.nz')
